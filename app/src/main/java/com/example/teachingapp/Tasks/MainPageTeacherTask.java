...
public class MainPageTeacherTask {

    private TeacherMainPage activity;
    ...
    public MainPageTeacherTask(TeacherMainPage activity, SharedPreferences sharedPreferences) {
