...
public class ShowActivityTotalRankingTest {
    ...
    @Rule
    public ActivityScenarioRule<ShowActivityTotalRanking> activityScenarioRule =
            new ActivityScenarioRule<>(ShowActivityTotalRanking.class);
    ...
    private void testRow(LinearLayout row, int i, boolean showInRanking, Long totalPoints, Long todayPoints) {
        ...
        assertThat(((TextView) row.getChildAt(2)).getGravity(), is(Gravity.CENTER));
    }
}
